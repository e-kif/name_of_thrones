...
def test_json_read_operations():
    ...
    assert json_db().read_character(1)['name'] == 'John Snow', 'Wrong character name for character_id=1'
    ...
    assert set(json_db().read_character(1).keys()) == set('id', 'name', 'house', 'animal', 'symbol', 'nickname', 'role', 'age', 'death', 'strength'), 'Not all character keys were retrieved'
